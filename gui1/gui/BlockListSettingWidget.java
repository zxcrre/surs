...
public final class BlockListSettingWidget extends SettingWidget {
   ...
   private static BlockListSettingWidget field1099;
   ...
   private final BlockListEditor field0922;
   ...
   public BlockListSettingWidget(BlockListSetting var1, Supplier<Float> var2) {
      super(Objects.requireNonNull(var1), Objects.requireNonNull(var2));
      this.field0922 = new BlockListEditor(var1, var2);
      this.field1343 = new PopupPanel(this.field0922);
   }
   ...
   public void method1414(class_332 var1, int var2, int var3, float var4) {
      ...
      String var11 = var9 != null ? var9 : "h";
      float var12 = var9 != null ? this.method0002() + 1.5F : this.method0002() + 2.0F;
   ...
   private void method2100(float var1, float var2) {
      method1915();
      float var3 = this.method0530() + this.method2047() - 8.0F;
      float var4 = this.method0002() + 4.0F;
      float var5 = this.method0645(var3);
      float var6 = var4 - this.field1343.method1762() / 2.0F + 8.0F;
      float var7 = ScreenLayoutHelper.method1762();
      if (var6 + this.field1343.method1762() > var7) {
         var6 = var7 - this.field1343.method1762() - 10.0F;
      }
      ...
      this.field0922.method2100(var3, var4);
      this.field0922.method1570(true);
      this.field1343.method2228();
      this.field1343.method0670(var5, var6);
   ...
   private void method2266() {
      this.field0922.method1570(false);
      this.field1388 = true;
   }

   public static void method1973() {
      if (field1099 != null && field1099.field1312) {
         field1099.method2266();
      }
   }

   public static void method0430() {
      if (field1099 != null) {
         field1099.field0922.method0498();
      }
   }
   ...
   public static void method2228() {
      if (field1099 != null) {
         ...
         if (var0 != null) {
            var0.method1620().remove(field1099.field1343);
         }

         field1099.field0922.method1570(false);
         field1099.field1312 = false;
         field1099.field1388 = false;
         field1099 = null;
      }
   }
