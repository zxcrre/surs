...
public record BlurRenderCommand(RenderSize size, CornerRadius radius, QuadColor color, float smoothness, float blurRadius) implements RenderCommand {
   private static final class_10156 BLUR_SHADER_KEY = new class_10156(ResourceHelper.method1012("blur"), class_290.field_1576, class_10149.field_53930);
   ...
   public void method1553(Matrix4f var1, float var2, float var3, float var4) {
      ...
      class_5944 var8 = RenderSystem.setShader(BLUR_SHADER_KEY);
      if (var8 == null) {
