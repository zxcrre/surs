...
public record CircularRectangleRenderCommand(RenderSize size, CornerRadius radius, QuadColor color, float smoothness) implements RenderCommand {
   private static final class_10156 RECTANGLE_CIRCULAR_SHADER_KEY = new class_10156(
      ResourceHelper.method1012("rectangle_circular"), class_290.field_1576, class_10149.field_53930
   );
   ...
   public void method1553(Matrix4f var1, float var2, float var3, float var4) {
      ...
      class_5944 var7 = RenderSystem.setShader(RECTANGLE_CIRCULAR_SHADER_KEY);
      if (var7 == null) {
