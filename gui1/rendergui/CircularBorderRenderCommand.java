...
public record CircularBorderRenderCommand(
   RenderSize size, CornerRadius radius, QuadColor color, float thickness, float internalSmoothness, float externalSmoothness
) implements RenderCommand {
   private static final class_10156 BORDER_CIRCULAR_SHADER_KEY = new class_10156(
      ResourceHelper.method1012("border_circular"), class_290.field_1576, class_10149.field_53930
   );
   ...
   public void method1553(Matrix4f var1, float var2, float var3, float var4) {
      ...
      class_5944 var7 = RenderSystem.setShader(BORDER_CIRCULAR_SHADER_KEY);
      if (var7 == null) {
         ...
         var7.method_34582("Smoothness").method_1255(this.internalSmoothness, this.externalSmoothness);
