...
public record RectangleRenderCommand(RenderSize size, CornerRadius radius, QuadColor color, float smoothness) implements RenderCommand {
   private static final class_10156 RECTANGLE_SHADER_KEY = new class_10156(
      ResourceHelper.method1012("rectangle"), class_290.field_1576, class_10149.field_53930
   );
